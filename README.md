...
Files can be categorized into types such as:
documents
images
source code
archives
...
All detected events are recorded in a log file:
integrity.log
...
Suspicious file detection is indicative only and should not be considered definitive malware identification.
